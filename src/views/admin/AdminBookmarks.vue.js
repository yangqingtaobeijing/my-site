...
if (__VLS_ctx.bookmarks.length === 0) {
    ...
    for (const [bookmark] of __VLS_vFor((__VLS_ctx.bookmarks))) {
        __VLS_asFunctionalElement1(__VLS_intrinsics.tr, __VLS_intrinsics.tr)({
            key: (bookmark.id),
            ...{ class: (['hover:bg-[var(--color-bg-elevated-soft)]', bookmark.hidden ? 'opacity-50' : '']) },
        });
        ...
        __VLS_asFunctionalElement1(__VLS_intrinsics.span, __VLS_intrinsics.span)({
            ...{ class: (['text-xs px-2 py-0.5 rounded font-[family-name:var(--font-mono)]', bookmark.hidden ? 'bg-gray-500/20 text-gray-400' : 'bg-emerald-500/10 text-emerald-400']) },
        });
        /** @type {__VLS_StyleScopedClasses['text-xs']} */ ;
        ...
        /** @type {__VLS_StyleScopedClasses['py-3.5']} */ ;
        /** @type {__VLS_StyleScopedClasses['text-right']} */ ;
        if (__VLS_ctx.deletingId === bookmark.id) {
            __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
            ...
            __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
                ...{ onClick: (...[$event]) => {
                        ...
                        if (!(__VLS_ctx.deletingId === bookmark.id))
                            return;
                        __VLS_ctx.doDelete(bookmark.id);
                        // @ts-ignore
                        [syncMsg, syncMsg, syncOk, bookmarks, bookmarks, extractDomain, deletingId, doDelete,];
                    } },
            ...
            __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
                ...{ onClick: (...[$event]) => {
                        ...
                        if (!!(__VLS_ctx.deletingId === bookmark.id))
                            return;
                        __VLS_ctx.toggleHidden(bookmark.id);
                        // @ts-ignore
            ...
            __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
                ...{ onClick: (...[$event]) => {
                        ...
                        if (!!(__VLS_ctx.deletingId === bookmark.id))
                            return;
                        __VLS_ctx.confirmDelete(bookmark.id);
                        // @ts-ignore
                        [confirmDelete,];
                    } },
